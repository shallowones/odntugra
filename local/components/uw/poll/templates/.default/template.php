...
<? if ($arResult['poll']): ?>
    <form class="vote wrapper" action="<? echo POST_FORM_ACTION_URI ?>" method="post">
        ...
        <? if ($arResult['poll']['options']): ?>
            <div class="vote-radio">
                <? foreach ($arResult['poll']['options'] as $optionId => $optionName): ?>
                    <input
                            ...
                            value="<? echo $optionId ?>"
                    />
                    <label class="vote-radio__label" for="<? echo 'option-' . $optionId ?>">
                        <? echo $optionName ?>
                    </label>
                <? endforeach; ?>
            </div>
            <div class="vote-contrs">
                ...
                <div class="vote-contrs-right">
                    <a class="link" href="<? echo $arResult['listLink'] ?>">Список опросов</a>
                </div>
            </div>
        <? elseif ($arResult['poll']['detail']): ?>
            <div class="vote-contrs">
                <div class="vote-contrs-right">
                    <a href="<? echo $arResult['poll']['detail'] ?>" class="vote__button">Пройти голосование</a>
                </div>
            </div>
        <? endif; ?>
    </form>
<? elseif ($arResult['answers']): ?>
    <div class="vote wrapper">
        ...
        <? if ($arResult['answers']['items']): ?>
            ...
            <div class="vote-contrs">
                <div class="vote-contrs-right">
                    <a href="<? echo $arResult['listLink'] ?>" class="link custom">Список опросов</a>
                </div>
            </div>
        <? elseif ($arResult['answers']['detail']): ?>
            <div class="vote-contrs">
                <div class="vote-contrs-right">
                    <a href="<? echo $arResult['answers']['detail'] ?>" class="vote__button">Посмотреть результаты</a>
                </div>
            </div>
        <? endif; ?>
    </div>
