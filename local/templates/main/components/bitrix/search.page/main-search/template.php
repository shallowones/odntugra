...
<?elseif(count($arResult["SEARCH"])>0):?>
	...
	<?foreach($arResult["SEARCH"] as $arItem):?>
        <a class="list-item" href="<?echo $arItem["URL"]?>">
            <?if($arItem["PREVIEW_PICTURE"]):?>
            <div class="list-item__img">
                <?if($arItem["PREVIEW_PICTURE"]):?><img src="<?=$arItem["PREVIEW_PICTURE"]?>"><?endif;?>
            </div>
            <div class="list-item-text">
                <div class="list-item-text__title"><?echo $arItem["TITLE_FORMATED"]?></div>
                <div class="list-item-text__desc"><?echo $arItem["BODY_FORMATED"]?></div>
                <div class="list-item-text__date"><?=$arItem["DATE_CHANGE"]?></div>
            </div>
                <?else:?>
                <div class="list-item-text__search">
                    <div class="list-item-text__title"><?echo $arItem["TITLE_FORMATED"]?></div>
                    <div class="list-item-text__desc"><?echo $arItem["BODY_FORMATED"]?></div>
                    <div class="list-item-text__date"><?=$arItem["DATE_CHANGE"]?></div>
                </div>
